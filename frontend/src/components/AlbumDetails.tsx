...
const testComments = [
  {
    id: 1,
    name: "Juan Pérez",
    description: "¡Me encanta la playa! Es el lugar perfecto para relajarse y disfrutar del sol.",
  },
  {
    id: 2,
    name: "María López",
    description: "No hay nada mejor que un buen libro y una bebida fría junto al mar.",
  },
  {
    id: 3,
    name: "Carlos Gómez",
    description: "Recuerden llevar protector solar. ¡La piel lo agradecerá!",
  },
]
    ...
    <div className="p-4 flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-2">
        ...
        {testComments.map((comment) => (
          <div key={comment.id} className="flex flex-col rounded-xl p-4 gap-2 border">
            <span><strong>{comment.name}</strong> dijo:</span>
